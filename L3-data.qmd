...
Handling missing data is a prominent challenge, particularly in the context of clinical data collection. What are some effective methods for managing missingness? What assumptions do these make? What would you want to know about data collection to decide which missing data approach makes more sense for your data?
:::
...
A variety of data normalization are performed in gene expression analysis. What are some of the different methods of normalization, what are some important assumptions they use, and what is their potential impact on data interpretability? For example what is the logic behind assuming that all samples have, say, the same median?
:::
